      ...
      body: SingleChildScrollView(
        child: SafeArea(
          child: Column(
            ...
            Text("Sign Up",style: TextStyle(color: Colors.pink[200],fontWeight: FontWeight.bold,fontSize: 30),),
            Padding(
              ...
              }, child: Text("Sign Up",style: TextStyle(color: Colors.pink[200],fontSize: 20),)),
              Row(
