...
class _MyGallerycalssState extends State<MyGallerycalss> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
       body: SafeArea(
         child: GridView.builder(itemCount: gallery.length+1, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 4,crossAxisSpacing: 2, mainAxisSpacing: 2), itemBuilder: (context, int index){
           if (index == gallery.length){
             ...
             return Container(
               height: 50,
               width: 50,
               child: Image(image: FileImage(gallery[index]!),fit: BoxFit.fill,),
             );
           }
         }),
       ),
