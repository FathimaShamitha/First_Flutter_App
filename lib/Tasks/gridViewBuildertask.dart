...
class _MyGridBuilderState extends State<MyGridBuilder> {
  ...
  List Name = ["Ahad Shuvo","Lyn R. Lermus","Katherine A. Stanfil","Robert K. Perez","Jason L. Bowling","Joseph A. Bove","Jack M. Peoples"];

  List Time = ["10:20 AM","10:40 AM","11:00 AM","11:20 AM","11:40 AM","12:00 AM","12:00 PM"];

  List Date = ["03.09.2023","03.09.2023","03.09.2023","03.09.2023","03.09.2023","03.09.2023","03.09.2023"];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: GridView.builder(itemCount: Name.length, gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2,crossAxisSpacing: 1,mainAxisSpacing: 4), itemBuilder: (context, int index){
          return Card(
            elevation: 4,
            child: Container(
              height: 600,
              ...
              child: Column(
                children: [
                  SizedBox(height: 4,),
                  CircleAvatar(radius: 30,backgroundImage: NetworkImage(ProfilePic[index]),),
                  SizedBox(height: 3,),
                  ...
                  Row(
                    ...
                    children: [
                      Text(Time[index],style: TextStyle(fontSize: 13),),
                      Text(Date[index],style: TextStyle(fontSize: 13),),
                    ],
                  ),
                  SizedBox(height: 3,),
                  Container(
                    ...
                    child: Center(child: Text("VIEW DETAILS",style: TextStyle(color: Colors.white,fontSize: 12),)),
                  )
                ],
              ),
            ),
